...
from pages.utils.model_train import get_rolling_mean, get_differencing_order, get_data, scaling, evaluate_model, get_forecast, inverse_scaling
import pandas as pd
...
close_price= get_data(ticker, start, end)
